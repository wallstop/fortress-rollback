...
description: "Rust Design Patterns guidance for Fortress Rollback. Use when Choosing design patterns, implementing builders, state machines, or strategy pattern."
---
