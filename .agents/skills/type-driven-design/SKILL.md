...
description: "Type-Driven Design -- Parse, Don't Validate guidance for Fortress Rollback. Use when Designing type-safe APIs, using newtypes, encoding state in types."
---
