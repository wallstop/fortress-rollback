...
description: "User-Facing Documentation Workflow guidance for Fortress Rollback. Use when New public API, breaking changes, new features, configuration changes, behavioral changes requiring user documentation; writing or revising user-facing docs prose, addressing vale prose suggestions, prose conventions and style."
---
...
**Related workflows:** [dev-pipeline.md](../dev-pipeline/SKILL.md) (full development lifecycle), [review-readiness.md](../review-readiness/SKILL.md) (pre-PR checks).
...
- Follow the existing format (see [changelog.md](../changelog/SKILL.md))
