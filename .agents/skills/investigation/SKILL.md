---
name: investigation
description: "Investigation and Debugging Workflow guidance for Fortress Rollback. Use when Debugging failures, diagnosing desyncs, root-cause analysis, systematic troubleshooting."
---
...
For security/correctness-sensitive bugs, run a scoped post-incident adversarial handoff using [adversarial-handoff.md](../adversarial-handoff/SKILL.md) Mode 2:
