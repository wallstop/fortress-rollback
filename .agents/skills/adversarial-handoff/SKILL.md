...
2. Run [adversarial-review.md](../adversarial-review/SKILL.md) on scoped files.
...
- [adversarial-review.md](../adversarial-review/SKILL.md) performs red-team-style challenge.
