---
name: determinism
description: "Determinism in Rust Games guidance for Fortress Rollback. Use when Ensuring determinism, replacing HashMap, float handling, cross-platform determinism."
---
