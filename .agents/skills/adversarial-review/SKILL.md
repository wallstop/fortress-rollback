...
description: "Adversarial Review Guide guidance for Fortress Rollback. Use when Security review, safety audit, adversarial testing, red-team analysis of changes."
---
