...
- Kani setup verified if running proof levels (see [kani.md](../kani/SKILL.md))
...
one-line record using the [design-decisions skill](../design-decisions/SKILL.md).
...
Run the readiness gate from [review-readiness.md](../review-readiness/SKILL.md), then perform targeted checks from [code-review.md](../code-review/SKILL.md):
