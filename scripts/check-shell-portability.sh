...
#
# Usage: ./scripts/check-shell-portability.sh [options]
#   ./scripts/check-shell-portability.sh            # Check all scripts
#   ./scripts/check-shell-portability.sh --verbose  # Show all files checked
#   ./scripts/check-shell-portability.sh --help     # Show help
#
# Exit codes:
