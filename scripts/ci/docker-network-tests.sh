...
#
# Usage:
#   ./scripts/ci/docker-network-tests.sh           # Run all tests
#   ./scripts/ci/docker-network-tests.sh basic     # Run only basic test
#   ./scripts/ci/docker-network-tests.sh --build   # Force rebuild before tests
#
# Requirements:
