...
#
# Usage:
#   ./scripts/check-llm-skills.sh              # Check .llm/ directory
#   ./scripts/check-llm-skills.sh --fix        # Print fix suggestions
#   ./scripts/check-llm-skills.sh --dir /path  # Check a custom directory
#
# Exit codes:
#   0 - No issues found
