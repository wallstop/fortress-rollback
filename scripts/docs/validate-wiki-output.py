...
Usage:
    python scripts/docs/validate-wiki-output.py
    python scripts/docs/validate-wiki-output.py --wiki-dir wiki
    python scripts/docs/validate-wiki-output.py --strict  # Fail on warnings too
"""
