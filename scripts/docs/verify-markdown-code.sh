...
#
# Usage:
#   ./scripts/docs/verify-markdown-code.sh              # Verify all markdown files
#   ./scripts/docs/verify-markdown-code.sh --verbose    # Show detailed output
#   ./scripts/docs/verify-markdown-code.sh --fix        # Show suggestions for fixes
#   ./scripts/docs/verify-markdown-code.sh --strict     # Don't auto-skip incomplete snippets
#   ./scripts/docs/verify-markdown-code.sh file.md      # Verify specific file
#
# The script handles:
