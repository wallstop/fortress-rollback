...
#
# Usage:
#   ./scripts/docs/check-code-fence-syntax.sh [directory]
#
# Exit codes:
#   0 - No issues found
...
#
# Examples:
#   ./scripts/docs/check-code-fence-syntax.sh           # Check docs/ directory
#   ./scripts/docs/check-code-fence-syntax.sh docs/     # Explicit directory
#   ./scripts/docs/check-code-fence-syntax.sh .         # Check all markdown files
