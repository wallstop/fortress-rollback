...
Usage:
    python scripts/docs/sync-wiki.py
    python scripts/docs/sync-wiki.py --source docs --dest wiki
    python scripts/docs/sync-wiki.py --dry-run
"""
...
Examples:
    python scripts/docs/sync-wiki.py
    python scripts/docs/sync-wiki.py --source docs --dest wiki
    python scripts/docs/sync-wiki.py --dry-run --verbose
        """,
    )
    parser.add_argument(
        "--source",
