...
in the tier lists in scripts/verification/verify-kani.sh.
...
def main() -> int:
    ...
    if missing_proofs:
        ...
        print("\nAdd them to one of the TIER*_PROOFS arrays in scripts/verification/verify-kani.sh", file=sys.stderr)
