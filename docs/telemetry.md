<!-- SYNC: This source doc syncs to wiki/Telemetry.md. -->
...
- [User Guide](user-guide.md) — integrating Fortress Rollback into your game
- [Production Checklist](production-checklist.md) — release monitoring requirements
- [Desync Playbook](desync-playbook.md) — incident capture and reproduction
- [Network Tuning](tuning.md) — interpreting baseline metrics
