...
python3 scripts/check-wiki-consistency.py                      # Wiki links
...
| `docs/` | `../` | `(../README.md)` |
| `.llm/skills/` | `../../` | `(../../README.md)` |

Common mistake: `(.llm/skills/file.md)` from `.llm/context.md` resolves to `.llm/.llm/skills/file.md`. Use `(skills/file.md)` instead.
...
- [ ] `./scripts/check-links.sh` -- no broken links
