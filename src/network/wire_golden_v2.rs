//! Immutable protocol-v2 wire fixtures.
//!
...
pub(super) const WIRE_GOLDEN_VERSION: u8 = 2;

const SYNC_REQUEST: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x30, 0x20, 0x10,
...
const SYNC_REPLY: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x80, 0x70, 0x60, 0x50,
    0x01, 0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x04, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x08, 0x00, 0x78,
    0x00, 0x00, 0x00, 0x18, 0x17, 0x16, 0x15, 0x14, 0x13, 0x12, 0x11,
];
const INPUT: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
...
const INPUT_ACK: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x4D, 0x00, 0x00, 0x00,
];
const QUALITY_REPORT: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xFE, 0xFF, 0x10, 0x0F,
    0x0E, 0x0D, 0x0C, 0x0B, 0x0A, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01,
];
const QUALITY_REPLY: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x20, 0x1F, 0x1E, 0x1D,
    0x1C, 0x1B, 0x1A, 0x19, 0x18, 0x17, 0x16, 0x15, 0x14, 0x13, 0x12, 0x11,
];
const CHECKSUM_REPORT: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x30, 0x2F, 0x2E, 0x2D,
    0x2C, 0x2B, 0x2A, 0x29, 0x28, 0x27, 0x26, 0x25, 0x24, 0x23, 0x22, 0x21, 0x58, 0x00, 0x00, 0x00,
];
const KEEP_ALIVE: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00,
];
const FLOOR_REQUEST: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x2A, 0x00, 0x00, 0x00,
];
const FLOOR_REPLY: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0x2A, 0x00, 0x00, 0x00,
    0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
    0x0A, 0x00, 0x00, 0x00,
];
const JOIN_REQUEST: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00,
];
const STATE_SNAPSHOT: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x0B, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00,
...
const STATE_SNAPSHOT_ACK: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00,
];
const REACTIVATE_SLOT: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x0D, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x29, 0x00, 0x00, 0x00,
];
const REACTIVATE_SLOT_ACK: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x0E, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x29, 0x00, 0x00, 0x00,
];
const JOIN_COMMITTED: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x29, 0x00, 0x00, 0x00,
];
const JOIN_ABORTED: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x29, 0x00, 0x00, 0x00,
];
const GOODBYE: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x03,
];
const DROP_PREPARE: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x02, 0x00, 0x07, 0x00,
...
const DROP_REPORT: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x13, 0x00, 0x00, 0x00, 0x02, 0x00, 0x07, 0x00,
...
const DROP_BACKFILL: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x02, 0x00, 0x07, 0x00,
...
const DROP_COMMIT: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x15, 0x00, 0x00, 0x00, 0x02, 0x00, 0x07, 0x00,
    0x40, 0x30, 0x20, 0x10, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x1F, 0x00, 0x00, 0x00,
    0x18, 0x17, 0x16, 0x15, 0x14, 0x13, 0x12, 0x11,
];
const DROP_ABORT: &[u8] = &[
    0xF5, 0x52, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0x16, 0x00, 0x00, 0x00, 0x02, 0x00, 0x07, 0x00,
    0x40, 0x30, 0x20, 0x10, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x02, 0x00, 0x00, 0x00,
];
...
#[test]
fn hot_join_v2_goldens_are_recognized_when_feature_is_disabled() {
    for (_, message) in fixtures().into_iter().filter(|(_, message)| {
        ...
        let error = super::decode_message(expected(&message.body))
