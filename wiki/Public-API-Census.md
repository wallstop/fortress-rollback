<!-- SYNC: This wiki page is generated from docs/api/public-api-census.md. Edit docs source. -->

# Public API Census

Fortress Rollback checks its complete callable Rust surface, including items that normal rustdoc
hides. The checked snapshot is [`public-api-snapshot.tsv`](https://github.com/wallstop/fortress-rollback/blob/main/docs/api/public-api-snapshot.tsv); reviewed
removals remain in [`public-api-removals.tsv`](https://github.com/wallstop/fortress-rollback/blob/main/docs/api/public-api-removals.tsv).
