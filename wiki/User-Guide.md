<!-- SYNC: This wiki page is generated from docs/user-guide.md. Edit docs source. -->
...
Start with [Build Your First Session](Getting-Started). That focused guide installs the crate,
...
Opt in via [`SessionBuilder::with_disconnect_behavior`](#complete-configuration-reference) ([contract](API-Contracts#with_disconnect_behaviorself-behavior-disconnectbehavior---self)):
