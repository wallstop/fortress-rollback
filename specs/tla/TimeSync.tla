...
(*                                                                         *)
(* Scope (this spec models ONE peer's window):                             *)
(*   This module models each peer's rolling window in isolation and proves *)
(*   its per-endpoint average_frame_advantage() bounded and deterministic. *)
(*   The CROSS-endpoint fold that combines these averages over N>=3 remotes *)
(*   into the session's WaitRecommendation (P2PSession::max_frame_advantage) *)
(*   is modeled in the companion spec FrameAdvantageAggregation.tla.        *)
(*                                                                         *)
