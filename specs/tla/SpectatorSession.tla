...
(*   - Multiple HOSTS / failover: this spec models a single host. The      *)
(*     production spectator receives from a VECTOR of redundant hosts and  *)
(*     fails over when the canonical host disconnects; that connect-status *)
(*     merge (converge-down to the live global-min freeze + provenance-     *)
(*     gated reactivation) is modeled in the companion SpectatorFailover.tla*)
(*     (audit F4 / critic-#1 / critic-#2).                                 *)
