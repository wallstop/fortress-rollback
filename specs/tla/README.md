...
| `SyncHandshakeV1Trace.tla` | generated by `verify-sync-handshake-traces.py` | ✓ CI | Strict hand-authored NDJSON trace contract: matching/mismatch/timeout pass and an exact duplicate-reply decrement mutation fails; no runtime instrumentation/refinement yet |
...
| `SyncHandshakeV1Trace` | None yet. The current fixtures are hand-authored; see `traces/sync-handshake-v1/README.md` for the candidate mapping and unresolved refinement gaps. |
